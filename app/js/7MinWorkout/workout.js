          ...
          workout.exercises.push({
              details: new Exercise({
                  ...
                  procedure: "Lie on your back with your knees bent and feet flat on the floor, hip-width apart.\
                              <br/>Place your hands behind your head so your thumbs are behind your ears.\
                              <br/>Hold your elbows out to the sides but rounded slightly in.\
                              <br/>Gently pull your abdominals inward.\
                              <br/>Curl up and forward so that your head, neck, and shoulder blades lift off the floor.\
                              <br/>Hold for a moment at the top of the movement and then lower slowly back down."
              }),
              duration: 30
          });
          workout.exercises.push({
              details: new Exercise({
                  ...
                  procedure: "Position your chair in front of you.\
                              <br/>Stand with your feet about hip width apart, arms at your sides.\
                              <br/>Step up onto the seat with one foot, pressing down while bringing your other foot up next to it. \
                              <br/>Step back with the leading foot and bring the trailing foot down to finish one step-up."
              }),
              duration: 30
          });
          workout.exercises.push({
              details: new Exercise({
                  ...
                  procedure: "Stand with your head facing forward and your chest held up and out.\
                              <br/>Place your feet shoulder-width apart or little wider. Extend your hands straight out in front of you.\
                              <br/>Sit back and down like you're sitting into a chair. Keep your head facing straight as your upper body bends forward a bit. Rather than allowing your back to round, let your lower back arch slightly as you go down.\
                              <br/>Lower down so your thighs are parallel to the floor, with your knees over your ankles. Press your weight back into your heels.\
                              <br/>Keep your body tight, and push through your heels to bring yourself back to the starting position."
              }),
              duration: 30
          });
          workout.exercises.push({
              details: new Exercise({
                  ...
                  procedure: "Sit up on a chair. Your legs should be slightly extended, with your feet flat on the floor.\
                              <br/>Place your hands edges of the chair. Your palms should be down, fingertips pointing towards the floor.\
                              <br/>Without moving your legs, bring your glutes forward off the chair.\
                              <br/>Steadily lower yourself. When your elbows form 90 degrees angles, push yourself back up to starting position."
              }),
              duration: 30
          });
          workout.exercises.push({
              details: new Exercise({
                  ...
                  procedure: "Get into pushup position on the floor.\
                              <br/>Bend your elbows 90 degrees and rest your weight on your forearms.\
                              <br/>Your elbows should be directly beneath your shoulders, and your body should form a straight line from head to feet.\
                              <br/>Hold this position."
              }),
              duration: 30
          });
          workout.exercises.push({
              details: new Exercise({
                  ...
                  procedure: "Start standing with feet hip-width apart. \
                              <br/>Do inplace jog with your knees lifting as much as possible towards your chest."
              }),
              duration: 30
          });
          workout.exercises.push({
              details: new Exercise({
                  ...
                  procedure: "Stand erect with your feet about one shoulder width apart.\
                              <br/>Put your hands on your hips, keep your back as straight as possible, relax your shoulders and keep your eyes facing directly ahead.\
                              <br/>Take a large step forward with one leg.\
                              <br/>As you step forward, lower your hips and bend your knees until they both form 90 degree angles.\
                              <br/>Return to starting position.\
                              <br/>Repeat with your alternate leg."
              }),
              duration: 30
          });
          workout.exercises.push({
              details: new Exercise({
                  ...
                  procedure: "Assume the classic pushup position, but as you come up, rotate your body so your right arm lifts up and extends overhead.\
                              <br/>Return to the starting position, lower yourself, then push up and rotate till your left hand points toward the ceiling."
              }),
              duration: 30
          });
          workout.exercises.push({
              details: new Exercise({
                  ...
                  procedure: "Lie on your side, in a straight line from head to feet, resting on your forearm.\
                              <br/>Your elbow should be directly under your shoulder.\
                              <br/>With your abdominals gently contracted, lift your hips off the floor, maintaining the line.\
                              <br/>Keep your hips square and your neck in line with your spine. Hold the position."
              }),
              duration: 30
          });
       return workout;
